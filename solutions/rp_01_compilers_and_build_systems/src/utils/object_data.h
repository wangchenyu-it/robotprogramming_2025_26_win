...
enum ValueType { BOOL, NUMBER, STRING, ARRAY, OBJECT, POINTER, POINTER_REF };
...
class ValueData {
 ...
 public:
  ...
  operator uint64_t() { return getUnsignedInt(); }
...
class NumberData : public ValueData {
 public:
  NumberData(double value = 0.0,
             int precision = std::numeric_limits<double>::max_digits10)
      : _value(value), _precision(precision) {}
  NumberData(float value = 0.0,
             int precision = std::numeric_limits<float>::max_digits10)
      : _value(value), _precision(precision) {}
  NumberData(int value = 0,
             int precision = std::numeric_limits<double>::digits10)
      : _value(value), _precision(precision) {}
  NumberData(uint64_t value = 0,
             int precision = std::numeric_limits<uint64_t>::digits10)
      : _value(value), _precision(precision) {}
  virtual int getInt();
  virtual uint64_t getUnsignedInt();
  virtual double getDouble();
...
class ArrayData : public ValueData {
 public:
  ...
  std::vector<ValueData*>::const_iterator begin() { return _value.begin(); }
  std::vector<ValueData*>::const_iterator end() { return _value.end(); }
  size_t capacity() { return _value.capacity(); }
  void reserve(size_t n) { _value.reserve(n); }
  ValueData& operator[](size_t n) { return *_value.at(n); }
  size_t size() { return _value.size(); }
  void push_back(ValueData* value) { _value.push_back(value); }
...
class ObjectData : public ValueData {
 public:
  using ValueData::getBool;
  using ValueData::getDouble;
  using ValueData::getFloat;
  using ValueData::getInt;
  using ValueData::getPointer;
  using ValueData::getReference;
  using ValueData::getString;
  using ValueData::getUnsignedInt;
  virtual ValueType type();
  virtual ObjectData& getObject();
  ...
  void setUnsignedInt(const std::string& name, uint64_t value,
                      const char* description_ = 0);
  ...
  void setPointer(const std::string& name, Identifiable* ptr,
                  const char* description_ = 0);
  void setPointer(const std::string& name, std::shared_ptr<Identifiable> ptr,
                  const char* description_ = 0) {
    setPointer(name, ptr.get(), description_);
  }

  int getInt(const std::string& name) { return getField(name)->getInt(); }
  ...
  float getFloat(const std::string& name) { return getField(name)->getFloat(); }

  const std::string& getString(const std::string& name) {
    return getField(name)->getString();
  }

  bool getBool(const std::string& name) { return getField(name)->getBool(); }

  const std::vector<std::string>& fields() { return _fields; }
...
class PointerReference : public ValueData {
 public:
  ...
  PointerReference& getReference() { return *this; }
...
std::pair<const std::string&, const bool&> field(const std::string& nm,
                                                 const bool& val);
std::pair<const std::string&, bool&> field(const std::string& nm, bool& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const bool&> f);
ObjectData& operator<<(ObjectData& o, std::pair<const std::string&, bool&> f);
ObjectData& operator>>(ObjectData& o, std::pair<const std::string&, bool&> f);

std::pair<const std::string&, const int&> field(const std::string& nm,
                                                const int& val);
std::pair<const std::string&, int&> field(const std::string& nm, int& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const int&> f);
ObjectData& operator<<(ObjectData& o, std::pair<const std::string&, int&> f);
ObjectData& operator>>(ObjectData& o, std::pair<const std::string&, int&> f);

std::pair<const std::string&, const uint64_t&> field(const std::string& nm,
                                                     const uint64_t& val);
std::pair<const std::string&, uint64_t&> field(const std::string& nm,
                                               uint64_t& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const uint64_t&> f);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, uint64_t&> f);
ObjectData& operator>>(ObjectData& o,
                       std::pair<const std::string&, uint64_t&> f);

std::pair<const std::string&, const float&> field(const std::string& nm,
                                                  const float& val);
std::pair<const std::string&, float&> field(const std::string& nm, float& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const float&> f);
ObjectData& operator<<(ObjectData& o, std::pair<const std::string&, float&> f);
ObjectData& operator>>(ObjectData& o, std::pair<const std::string&, float&> f);

std::pair<const std::string&, const double&> field(const std::string& nm,
                                                   const double& val);
std::pair<const std::string&, double&> field(const std::string& nm,
                                             double& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const double&> f);
ObjectData& operator<<(ObjectData& o, std::pair<const std::string&, double&> f);
ObjectData& operator>>(ObjectData& o, std::pair<const std::string&, double&> f);

std::pair<const std::string&, const std::string&> field(const std::string& nm,
                                                        const std::string& val);
std::pair<const std::string&, std::string&> field(const std::string& nm,
                                                  std::string& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, const std::string&> f);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, std::string&> f);
ObjectData& operator>>(ObjectData& o,
                       std::pair<const std::string&, std::string&> f);

std::pair<const std::string&, ValueData*&> field(const std::string& nm,
                                                 ValueData*& val);
ObjectData& operator<<(ObjectData& o,
                       std::pair<const std::string&, ValueData*&> f);
ObjectData& operator>>(ObjectData& o,
                       std::pair<const std::string&, ValueData*&> f);
